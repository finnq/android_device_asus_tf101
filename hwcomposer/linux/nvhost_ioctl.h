...
#define NVHOST_IOCTL_CHANNEL_GET_CLK_RATE _IOR(NVHOST_IOCTL_MAGIC, 9, struct nvhost_clk_rate_args)
...
#define NVHOST_IOCTL_CHANNEL_GET_TIMEDOUT _IOR(NVHOST_IOCTL_MAGIC, 12, struct nvhost_get_param_args)
#define NVHOST_IOCTL_CHANNEL_SET_PRIORITY \
    _IOW(NVHOST_IOCTL_MAGIC, 13, struct nvhost_set_priority_args)
#define NVHOST_IOCTL_CHANNEL_LAST _IOC_NR(NVHOST_IOCTL_CHANNEL_SET_PRIORITY)
...
#define NVHOST_IOCTL_CTRL_LAST _IOC_NR(NVHOST_IOCTL_CTRL_GET_VERSION)
